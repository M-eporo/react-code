...
function UseApp() {
    return (
        <div>
            ...
            <LazyImage src="https://picsum.photos/400/200?random=1" alt="Image01" />
            <div style={{height: "50vh"}}></div>
            <LazyImage src="https://picsum.photos/400/200?random=2" alt="Image02"/>
            <div style={{height: "50vh"}}></div>
            <LazyImage src="https://picsum.photos/400/200?random=3" alt="Image03" />
            <div style={{height: "50vh"}}></div>
        </div>
